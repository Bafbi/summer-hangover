    ...
    return (
      <>
        <main className="bg-surface grid grid-cols-1 gap">
          ...
          <div className="sortie flex justify-between items-center w-full">
          <Link href="/other-content-2" className="bg-primary-container my-4 flex-initial max-w-xs w-1/6 cursor-pointer items-center justify-center space-x-2 rounded-r-xl p-2 transition-transform hover:scale-105" style={{ minHeight: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <span className="material-icons">add_circle</span>
          </Link>
          <Link href="/other-content-2" className="bg-primary-container max-w-60 my-4 flex-grow flex w-full cursor-pointer items-center justify-center space-x-reverse space-x-2 rounded-l-xl p-2 transition-transform hover:scale-105" style={{ minHeight: '60px' }} passHref>
            <div>
              Proposer une soirée
            </div>
          </Link>
